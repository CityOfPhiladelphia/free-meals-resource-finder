export default{
  ...
  "sections": {
    "foodSites": {
      ...
      "subsections": {
        ...
        "Community Refrigerators": {
          ...
          "pickupDetails": "Community Refrigerators are open 24 hours a day, 7 days a week and anyone can take the available food at any time. Community Refrigerators are run by community-based organizations and volunteers. Availability of food will vary based on donations. Visit each Community Refrigerator website for more details."
        },
        "General Food Site": {
      ...
      "subsections": {
        "PCA": {
          ...
          "eligibility": {
            ...
            "p2": "To learn about other services or to get help in another language, call the PCA helpline at <b><a class='underlined' href='tel:+12157659040'>(215) 765-9040</a>."
          },
          "pickupDetails": {
            "p1": "Older adult meal sites offer ready-to-eat meals.",
    ...
    "publicBenefits": {
      ...
      "subsections": {
        "WIC": {
          "name": "WIC",
          "eligibility": "WIC serves pregnant people, people who have recently had a baby, and children under five years old, including foster children. To receive WIC, you must meet <a href='https://pawic.com/IncomeGuidelines.aspx' target='_blank'>the income guidelines</a>.",
          "pickupDetails": "WIC provides nutrition services, breastfeeding support, and referrals for health care and social services. Through WIC, you can also receive benefits to help you purchase healthy foods. To get started, call the WIC office that you plan to visit."
        },
        "BenePhilly": {
          "name": "BenePhilly",
    ...
    "moreResources": {
      ...
      "p1": "Want to learn more? Explore other options for <a href='https://www.phila.gov/services/mental-physical-health/find-free-food-or-meals/' target='_blank'>getting free food and additional support</a>.  If you need help <a href='https://www.phila.gov/services/payments-assistance-taxes/financial-services-for-residents/get-free-help-applying-for-public-benefits/' target='_blank'>applying for public benefits</a>, call the BenePhilly Helpline at <a href='tel:8009945537'>(800) 994-5537</a>."
    }
  },
  "time": {
  ...
  "exceptions": {
    "Some hours are by appointment only.  Contact the site for more information.": "Some hours are by appointment only.  Contact the site for more information.",
    "Open on second and fourth Mondays of the month": "Open on second and fourth Mondays of the month",
    "Open on first and third Mondays of the month": "Open on first and third Mondays of the month",
    "Open for Breakfast 7:00-8:30, and Dinner 4:00-5:30": "Open for Breakfast 7:00-8:30, and Dinner 4:00-5:30",
    "Open Mondays for seniors only": "Open Mondays for seniors only",
    "For new or returning FIGHT medical center clients only": "For new or returning FIGHT medical center clients only",
    "Open on first and third Monday of the month": "Open on first and third Monday of the month",
    "Open on second and fourth Tuesdays of the month": "Open on second and fourth Tuesdays of the month",
    "Open on first and third Tuesdays of the month": "Open on first and third Tuesdays of the month",
    "Open Tuesdays for seniors only": "Open Tuesdays for seniors only",
    "This site serves adults only.": "This site serves adults only",
    "Open on the second and fourth Tuesdays of the month": "Open on the second and fourth Tuesdays of the month",
    "Open on the third Tuesday of the month": "Open on the third Tuesday of the month",
    "Open on the first and third Tuesdays of the month": "Open on the first and third Tuesdays of the month",
    "Open on the second Tuesday of the month": "Open on the second Tuesday of the month",
    "Open on the fourth Tuesday of the month": "Open on the fourth Tuesday of the month",
    "Open 1pm-3pm the first Tuesday of the month. Open 11am-1pm the second, fourth, and fifth Tuesdays of the month.": "Open 1pm-3pm the first Tuesday of the month. Open 11am-1pm the second, fourth, and fifth Tuesdays of the month.",
    "Open on the first Tuesday of the month": "Open on the first Tuesday of the month",
    "Open on first and third Wednesdays of the month": "Open on first and third Wednesdays of the month",
    "Open on the second and fourth Wednesdays of the month": "Open on the second and fourth Wednesdays of the month",
    "Open on the second Wednesday of the month": "Open on the second Wednesday of the month",
    "Open on the fourth Wednesday of the month": "Open on the fourth Wednesday of the month",
    "Open Wednesdays for seniors only": "Open Wednesdays for seniors only",
    "Open every other Wednesday": "Open every other Wednesday",
    "Open Wednesday morning to seniors only": "Open Wednesday morning to seniors only",
    "Open on the fourth Wednesday evening of the month": "Open on the fourth Wednesday evening of the month",
    "Open every other Wednesday. Some hours are by appointment only.  Contact the site for more information.": "Open every other Wednesday. Some hours are by appointment only. Contact the site for more information.",
    "Open on first and third Thursdays of the month": "Open on first and third Thursdays of the month",
    "Open on the second and fourth Thursday of the month": "Open on the second and fourth Thursday of the month",
    "Open on first, third, and fifth Thursdays of the month": "Open on first, third, and fifth Thursdays of the month",
    "Open every other Thursday of the month": "Open every other Thursday of the month",
    "Open on the fourth Thursday of the month": "Open on the fourth Thursday of the month",
    "Open on the Thursday after the second Tuesday of the month": "Open on the Thursday after the second Tuesday of the month",
    "Open on fourth Thursday of the month": "Open on fourth Thursday of the month",
    "Open on the last Thursday of the month": "Open on the last Thursday of the month",
    "Some hours are by appointment only. Contact the site for more information.": "Some hours are by appointment only. Contact the site for more information.",
    "Open on the second Thursday of the month": "Open on the second Thursday of the month",
    "Open on the first and third Fridays of the month": "Open on the first and third Fridays of the month",
    "Open on the second and fourth Friday of the month": "Open on the second and fourth Friday of the month",
    "Open on first and third Fridays of the month": "Open on first and third Fridays of the month",
    "Open on the third Friday of the month": "Open on the third Friday of the month",
    "Open every other Friday of the month": "Open every other Friday of the month",
    "Open on the first Friday of the month": "Open on the first Friday of the month",
    "Open on first Saturday of the month": "Open on first Saturday of the month",
    "Open on the third Saturday of the month": "Open on the third Saturday of the month",
    "Open on the fourth Saturday of the month": "Open on the fourth Saturday of the month",
    "Open on first and third Saturdays of the month": "Open on first and third Saturdays of the month",
    ...
    "Open on the second Saturday of the month": "Open on the second Saturday of the month",
    "Open on the last Saturday of the month": "Open on the last Saturday of the month",
    "Open on the second and fourth Saturday of the month": "Open on the second and fourth Saturday of the month",
    "Open on the third and fourth Saturdays of the month": "Open on the third and fourth Saturdays of the month",
    "Open on the first and third Saturdays of the month": "Open on the first and third Saturdays of the month",
