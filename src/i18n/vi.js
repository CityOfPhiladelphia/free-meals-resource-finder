...
export default {
  ...
  categoryType: {
    category: 'thể loại',
    generalMealSite: 'Các địa điểm cung cấp suất ăn theo bữa',
    foodSite: 'Điểm phát thực phẩm',
  ...
  holidayClosure: 'Vietnamese This site is currently temporarily closed for a holiday.',
  futureHolidayClosure: 'Vietnamese This site will by temporarily closed for a holiday on ',
  weatherClosure: 'Vietnamese This site is currently temporarily closed due to weather.',
  temporaryClosure: 'Vietnamese This site is currently temporarily closed.',
  ...
  sections: {
    ...
    studentMealSites: {
      ...
      subsections: {
        ...
        'PHA': {
          ...
          pickupDetails: 'Phải ăn tại chỗ. Để biết thêm thông tin, xin tới địa điểm.',
          eligibility: 'Tất cả trẻ em và thanh thiếu niên đều đủ điều kiện. Không cần ID.',
        },
        'CHARTER': {
    ...
    foodPantries: {
      ...
      li2: 'Trang  <a target="_blank" href="https://www.phila.gov/departments/office-of-homeless-services/">web của Office of Homeless Services</a> có liệt kê nhiều điểm phát bữa ăn miễn phí hơn. ',
      li3: '<a target="_blank" href="https://communityresourceconnects.org/">Community Resource Connects</a> có thực phẩm và các nguồn lực khác.',
      li4: "Tìm chợ nông sản trên Công cụ tìm chợ <a  target='_blank' href='https://www.phila.gov/farmers-markets/' target='_blank'>nông</a> sản của Thành phố Philadelphia.",
