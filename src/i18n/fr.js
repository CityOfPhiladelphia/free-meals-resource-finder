...
export default {
  ...
  categoryType: {
    category: 'Catégorie',
    generalMealSite: 'Sites de restauration générale',
    foodSite: 'Sites de distribution alimentaire',
  ...
  holidayClosure: 'French This site is currently temporarily closed for a holiday.',
  futureHolidayClosure: 'French This site will by temporarily closed for a holiday on ',
  weatherClosure: 'French This site is currently temporarily closed due to weather.',
  temporaryClosure: 'French This site is currently temporarily closed.',
  ...
  sections: {
    ...
    communityRefrigerators: {
      header:  'Réfrigérateurs communautaires ',
      eligibility: 'Tout le monde peut se rendre dans un Réfrigérateur communautaire pour y prendre de la nourriture. ',
      pickupDetails: 'Les Réfrigérateurs communautaires sont ouverts 24 heures sur 24, 7 jours sur 7, et tout le monde peut prendre les aliments disponibles à tout moment. \
      Les Réfrigérateurs communautaires sont gérés par des organisations communautaires et des bénévoles. \
      La disponibilité des aliments varie en fonction des dons. \
      Visitez le site Web de chaque Réfrigérateur communautaire pour plus d’informations. ',
      subsections: {
        'compiled': {
    ...
    foodPantries: {
      ...
      li2: '<a target="_blank" href="https://www.phila.gov/departments/office-of-homeless-services/">Le site Internet de l\'Office of Homeless Services (Bureau des services aux sans-abri)</a> recense d\'autres lieux offrant des repas gratuits. ',
      li3: '<a target="_blank" href="https://communityresourceconnects.org/">Le site Community Resource Connects </a> propose de la nourriture et d\'autres ressources.',
      li4: "Trouvez un marché fermier sur l'outil de recherche des <a target='_blank' href='https://www.phila.gov/farmers-markets/' target='_blank'>marchés fermiers</a> de la ville de Philadelphie.",
