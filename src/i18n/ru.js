...
export default {
  ...
  categoryType: {
    category: 'Категория',
    generalMealSite: 'Пункты выдачи еды',
    foodSite: 'Пункт выдачи питания',
  ...
  holidayClosure: 'Russian This site is currently temporarily closed for a holiday.',
  futureHolidayClosure: 'Russian This site will by temporarily closed for a holiday on ',
  weatherClosure: 'Russian This site is currently temporarily closed due to weather.',
  temporaryClosure: 'Russian This site is currently temporarily closed.',
  ...
  sections: {
    ...
    studentMealSites: {
      ...
      subsections: {
        ...
        'PHA': {
          ...
          pickupDetails: 'Прием пищи должен осуществляться на месте. Для получения дополнительных сведений посетите пункт питания.',
          eligibility: 'Право на получение помощи есть у всех детей и подростков. Удостоверение личности не требуется.',
    ...
    foodPantries: {
      ...
      li2: 'Посетите сайт Службы помощи бездомным<a target="_blank" href="https://www.phila.gov/departments/office-of-homeless-services/"> (Office of Homeless Services)</a>, чтобы узнать адреса пунктов выдачи бесплатного питания. ',
      li3: 'Посетите сайт  <a target="_blank" href="https://communityresourceconnects.org/">Community Resource Connects</a>, чтобы ознакомиться с информацией о пунктах выдачи питания и прочих ресурсах в вашем регионе.',
      li4: "Найдите фермерский рынок в приложении <a target='_blank' href='https://www.phila.gov/farmers-markets/' target='_blank'>Farmers' Market Finder</a> в Филадельфии.",
