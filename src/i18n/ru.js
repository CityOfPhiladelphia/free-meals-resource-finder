  ...
  sections: {
    ...
    studentMealSites: {
      ...
      custom: {
        ...
        // ',
        info: 'Следите за обновлениями о раздаче еды во время школьных каникул.<br>\
         <a href="https://www.philasd.org/foodservices/">Для получения информации об организации питания в школе для учащихся посетите страницу службы питания школьного округа Филадельфии.</a></li></ul>',
      },
    },
    olderAdultMealSites: {
