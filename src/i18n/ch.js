export default{
  ...
  "exceptions": {
    ...
    "Open on first and third Saturday of the month": "每月第一个和第三个星期六开放",
    "Open on second and fourth Monday of the month": "每月第二和第四个星期一开放",
    "Open on first and third Wednesday of the month": "每月第一个和第三个星期三开放",
    "Open on first Monday of the month": "每月的第一个星期一开放",
    "Open on first Tuesday of the month": "每月的第一个星期二开放",
    "Open on third Thursday of the month": "本月的第三个星期四开放",
    ...
    "Open on first and third Friday of the month": "每月第一个和第三个星期五开放",
    "Open on second and fourth Saturday of the month": "每月第二和第四个星期六开放",
    "Open on first Friday of the month": "本月的第一个星期五开放",
