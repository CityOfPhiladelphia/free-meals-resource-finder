...
export default {
  ...
  change: '日程表变更',
  closure: '临时关闭',
  holidayClosure: 'Chinese This site is currently temporarily closed for a holiday.',
  futureHolidayClosure: 'Chinese This site will by temporarily closed for a holiday on ',
  weatherClosure: 'Chinese This site is currently temporarily closed due to weather.',
  temporaryClosure: 'Chinese This site is currently temporarily closed.',
  ...
  sections: {
    ...
    studentMealSites: {
      ...
      subsections: {
        ...
        'PHA': {
          ...
          pickupDetails: '餐食须在现场食用。 欲了解更多信息，请前往供应点咨询。',
          eligibility: '所有儿童和青年人都合格。 不需要出示身份证件。',
        },
        'CHARTER': {
          name: '特许学校',
    ...
    foodPantries: {
      ...
      li2: '无家可归者服务办公室 <a target="_blank" href="https://www.phila.gov/departments/office-of-homeless-services/">(Office of Homeless Services)</a>  网站列出了更多的免费餐食供应场所。',
      li3: '社区资源联络点  <a target="_blank" href="https://communityresourceconnects.org/">(Community Resource Connects) </a> h可提供食物和其他资源。',
      li4: "在费城的农贸市场搜索器上<a target='_blank' href='https://www.phila.gov/farmers-markets/' target='_blank'>查找农贸市场</a>。",
      h2:'获取协助以申请福利。  ',
