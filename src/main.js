...
let $config = {
  ...
  sections: {
    foodSites: {
      ...
      color: '#0F4D90',
      subsections: [ 'Community Refrigerators', 'Free Grocery Site' ],
    },
    generalMealSites: {
      ...
      subsections: [ 'Broad Street Ministry', 'Office of Homeless Services', 'Free Meal Site' ],
    },
    studentMealSites: {
  ...
  footer: [
    ...
    {
      type: "native",
      href: "https://phila.formstack.com/forms/food_and_meal_finder_feedback",
      attrs: {
        target: "_blank",
      },
      text: "app.feedback",
